...
def sfb1d_atrous(lo, hi, g0, g1, mode='periodic', dim=-1, dilation=1,
                 pad1=None, pad=None):
...
if __name__ == '__main__':
    ...
    input0 = torch.tensor(img).reshape(2, 1, 512, 512).float()
    input = torch.cat((input0, input0, input0), dim = 1)
