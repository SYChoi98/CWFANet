...
class _MSDataLoaderIter(_DataLoaderIter):
    def __init__(self, loader):
        self.dataset = loader.dataset      # train or test set
        self.scale = loader.scale          #[2]
        self.collate_fn = loader.collate_fn #default
        self.batch_sampler = loader.batch_sampler
        self.num_workers = loader.num_workers   #0
...
class MSDataLoader(DataLoader):               # dataset 설정 및 batch, pin등등 설정
    def __init__(
